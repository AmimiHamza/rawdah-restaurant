...
const translations = {
  ...
  ar: {
    ...
    reservation: {
      ...
      deposit:    'يُطلب دفع 150 ريال للشخص كعربون لأمسيات الخميس والجمعة',
      cta:        'تأكيد الحجز',
      times:      ['12:00', '13:00', '14:00', '19:00', '20:00', '20:30', '21:00', '21:30', '22:00'],
    ...
    order: {
      ...
      orderPlaced:'تم تأكيد طلبك! وقت التوصيل المقدر: 45–60 دقيقة.',
    },
    privateDining: {
    ...
    footer: {
      ...
      hours:   'يومياً 12:00 – 15:00 | 19:00 – 00:00',
      address: 'طريق الملك فهد، حي العليا، الرياض 12211',
      phone:   '966 11 XXX XXXX+',
      follow:  'تابعنا',
      rights:  '© 2025 مطعم روضة. جميع الحقوق محفوظة.',
