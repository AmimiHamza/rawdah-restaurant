...
const stats: StatCard[] = [
  ...
  },
  {
    ...
    value: { en: '27',            fr: '27',              ar: '٢٧'             },
    delta: { en: '+8',            fr: '+8',              ar: '٨+'             },
    positive: true,
  },
  {
    icon: <Star size={20} />,
    label: { en: 'Avg. Order',    fr: 'Commande moy.',   ar: 'متوسط الطلب'    },
    value: { en: '132 SAR',       fr: '132 SAR',         ar: '١٣٢ ر.س'        },
    delta: { en: '+5',            fr: '+5',              ar: '٥+'             },
    positive: true,
  },
  {
    icon: <TrendingUp size={20} />,
    label: { en: 'Orders Today',  fr: 'Commandes du jour', ar: 'طلبات اليوم'  },
    value: { en: '134',           fr: '134',             ar: '١٣٤'            },
    delta: { en: '+12',           fr: '+12',             ar: '١٢+'            },
    positive: true,
  },
];
