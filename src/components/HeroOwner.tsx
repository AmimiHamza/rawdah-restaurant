...
const content: Record<string, { badge: string; title1: string; title2: string; title3: string; title4: string; sub: string; cta1: string; cta2: string; badge2: string }> = {
  ...
  ar: {
    ...
    title3:   'بمستوى',
    title4:   'مطبخك الراقي',
    sub:      '0 ريال رسوم تأسيس. نبني موقعك الفاخر — لوحة تحكم، حجوزات، دفع إلكتروني — مقابل اشتراك شهري بسيط. تنطلق خلال أيام وليس أشهراً.',
    cta1:     'ابدأ بـ 0 ريال اليوم',
    cta2:     'شاهد لوحة التحكم',
    badge2:   '0 ريال تأسيس · بدون التزامات · 100٪ مخصص',
  },
};
...
const floatingCards: Record<string, { icon: string; label: string; value: string }[]> = {
  ...
  ar: [
    { icon: '📅', label: 'الحجوزات',   value: '+147 هذا الأسبوع' },
    { icon: '⭐', label: 'التقييم',     value: '4.9 / 5.0' },
    { icon: '💰', label: 'الإيرادات',  value: '+23٪ هذا الشهر' },
  ],
};
